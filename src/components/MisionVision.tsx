            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid md:grid-cols-2 gap-8 lg:gap-16">
                    ...
                    <div className="relative group h-full">
                        ...
                        <div className="relative h-full bg-emerald-50 p-8 lg:p-10 rounded-2xl border border-emerald-100 shadow-xl shadow-emerald-900/5 hover:shadow-2xl hover:shadow-emerald-900/10 transition-all duration-300 flex flex-col">
                    ...
                    <div className="relative group h-full">
                        ...
                        <div className="relative h-full bg-emerald-50 p-8 lg:p-10 rounded-2xl border border-teal-100 shadow-xl shadow-teal-900/5 hover:shadow-2xl hover:shadow-teal-900/10 transition-all duration-300 flex flex-col">
