    ...
    return (
      <div className={`flex items-start gap-3 group ${className}`}>
        ...
        <div className="relative flex items-center justify-center w-5 h-5 shrink-0 mt-[2px]">
          ...
          {/* Custom Visual Circle (Border) */}
          <div 
            className={`
              absolute inset-0 w-full h-full rounded-full transition-all duration-200 border-2 bg-white z-0
          ...
          {/* Inner Dot */}
          <div 
            className="w-2.5 h-2.5 rounded-full bg-brand-primary opacity-0 scale-50 transition-all duration-200 peer-checked:opacity-100 peer-checked:scale-100 z-10 pointer-events-none" 
          />
        </div>
