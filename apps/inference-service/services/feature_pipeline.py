...
def construir_features_globales(
    ...
    return XGBoostFeatures(
        ...
        internal_cargo_temp_c=telemetry.internal_cargo_temp_c if telemetry.internal_cargo_temp_c is not None else max_temp_c,
        internal_cargo_humidity_pct=telemetry.internal_cargo_humidity_pct if telemetry.internal_cargo_humidity_pct is not None else relative_humidity_pct,
