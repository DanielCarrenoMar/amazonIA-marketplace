      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" className="flex items-center gap-3">
            <img src={logo.src} alt="Arapaima Logo" className="h-14 w-14" />
            <div>
              <div className="text-emerald-800 font-bold">Amazonia IA</div>
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 ml-2">
              ...
              {/* Login Button */}
              <button
                className="text-gray-700 hover:text-emerald-600 px-4 py-2 rounded-lg transition-colors font-medium"
              >
                Login
              </button>
